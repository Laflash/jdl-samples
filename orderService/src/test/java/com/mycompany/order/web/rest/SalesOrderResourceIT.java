...
import com.mycompany.order.repository.search.SalesOrderSearchRepository;
...
public class SalesOrderResourceIT {
     ...
     *
     * @see com.mycompany.order.repository.search.SalesOrderSearchRepositoryMockConfiguration
     */
    @Autowired
