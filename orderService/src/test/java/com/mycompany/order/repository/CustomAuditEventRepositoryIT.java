...
import com.mycompany.order.config.audit.AuditEventConverter;
import com.mycompany.order.domain.PersistentAuditEvent;
...
import static com.mycompany.order.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
