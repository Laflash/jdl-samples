...
describe('Customer e2e test', () => {
  ...
  it('should create and save Customers', async () => {
    ...
    await promise.all([
      ...
      customerUpdatePage.setTownCityInput('townCity'),
      customerUpdatePage.setCountyInput('county'),
    ...
    expect(await customerUpdatePage.getTownCityInput()).to.eq('townCity', 'Expected TownCity value to be equals to townCity');
    expect(await customerUpdatePage.getCountyInput()).to.eq('county', 'Expected County value to be equals to county');
