package com.mycompany.store.web.gateway.responserewriting;
...
import static com.mycompany.store.web.gateway.responserewriting.SwaggerBasePathRewritingFilter.gzipData;
