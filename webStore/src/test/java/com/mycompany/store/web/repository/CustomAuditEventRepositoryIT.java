...
import com.mycompany.store.web.config.audit.AuditEventConverter;
import com.mycompany.store.web.domain.PersistentAuditEvent;
...
import static com.mycompany.store.web.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
