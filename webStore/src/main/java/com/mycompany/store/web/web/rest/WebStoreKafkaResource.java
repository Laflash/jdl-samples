...
@RestController
@RequestMapping("/api/web-store-kafka")
public class WebStoreKafkaResource {

    private final Logger log = LoggerFactory.getLogger(WebStoreKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public WebStoreKafkaResource(KafkaProperties kafkaProperties) {
