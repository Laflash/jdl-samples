...
To build the final jar and optimize the webStore application for production, run:
...
Then navigate to [http://localhost:9042](http://localhost:9042) in your browser.
