...
import com.mycompany.storeservice.repository.search.PhotoSearchRepository;
...
public class PhotoResourceIT {
     ...
     *
     * @see com.mycompany.storeservice.repository.search.PhotoSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void searchPhoto() throws Exception {
        ...
        // Initialize the database
        photoRepository.saveAndFlush(photo);
        when(mockPhotoSearchRepository.search(queryStringQuery("id:" + photo.getId())))
